...
## Additional things
A [screenshot script](https://github.com/Atemo-C/NixOS-configuration/blob/Throwaway/extra-modules/atemo_cajaku/packages/niri-screenshot.nix) is provided. It leverages Niri's built-in screenshot utility, and extends it with others to have a more complete and intuitive screenshot experience. The tools used in the script do not "pollute" the user's environment, and are self-contained to the script. \
