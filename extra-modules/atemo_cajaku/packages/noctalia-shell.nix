# Since it sometimes takes a long time for noctalia-shell to be updated in nixpkgs,
# I fetch the latest version, either myself or from a kind soul in an open PR on nixpkgs' GitHub repository.
{
  fetchFromGitHub,
  lib,
  nix-update-script,
