...
#	fileSystems."/run/media/atemo/480GB-SSD-INT" = {
...
#	fileSystems."/run/media/atemo/500GB-HDD-INT" = {
...
#	fileSystems."/run/media/atemo/1TB-HDD-INT" = {
...
#	fileSystems."/run/media/atemo/1TB-HDD-EXT" = {
...
#	fileSystems."/run/media/atemo/150GB-HDD-5400RPM-INT" = {
